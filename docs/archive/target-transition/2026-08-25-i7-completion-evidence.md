...
> This file is retained only as historical evidence. Its I7/Target-RC and disposable-migration commands must **not** be executed after the 2026-08-28 development reset. The active validation authority is [`docs/validation/production-cutover.md`](../../validation/production-cutover.md).
