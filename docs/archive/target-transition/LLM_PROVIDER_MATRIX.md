...
>
> Archived during the 2026-08-28 canonical local-Ollama cutover. This document describes removed
> multi-provider model configuration and must not be used to implement or configure the current runtime.
