...
> This file is retained only as historical evidence. Its I0/Target-transition commands and assumptions must **not** be executed after the 2026-08-28 development reset. The current handoff authority is [`docs/goal.md`](../../goal.md) and the current cutover plan is [`2026-08-28-development-cutover.md`](../../plans/2026-08-28-development-cutover.md).
