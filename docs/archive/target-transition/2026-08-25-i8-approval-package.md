...
> This file is retained only as historical evidence. Its I8 real-copy, migration, rollback, and disposal commands must **not** be executed after the 2026-08-28 development reset. No real-data operation is authorized by the active plan; see [`docs/goal.md`](../../goal.md).
