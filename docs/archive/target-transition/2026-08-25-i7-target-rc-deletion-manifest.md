...
> This file is retained only as historical evidence. Its I7/Target-RC closure and deletion-manifest commands must **not** be executed after the 2026-08-28 development reset. The active source-closure contract is [`docs/validation/production-cutover.md`](../../validation/production-cutover.md).
