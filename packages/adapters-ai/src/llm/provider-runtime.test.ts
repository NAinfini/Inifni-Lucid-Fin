...
describe('provider runtime presets', () => {
  it('exposes the supported mainstream preset providers with protocol metadata', () => {
    expect(
      ...
      { id: 'siliconflow', protocol: 'openai-compatible', authStyle: 'bearer' },
      { id: 'doubao', protocol: 'openai-compatible', authStyle: 'bearer' },
      { id: 'zhipu', protocol: 'openai-compatible', authStyle: 'bearer' },
      { id: 'moonshot', protocol: 'openai-compatible', authStyle: 'bearer' },
      { id: 'baichuan', protocol: 'openai-compatible', authStyle: 'bearer' },
      { id: 'stepfun', protocol: 'openai-compatible', authStyle: 'bearer' },
      { id: 'volcengine-ark', protocol: 'openai-compatible', authStyle: 'bearer' },
