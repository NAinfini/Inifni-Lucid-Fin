...
export function createProjectCapabilitiesReadModel(store: Store): ProjectCapabilitiesReadModel {
  return Object.freeze({
    get(projectId: string) {
      return projectCapabilities(getStoreDatabase(store), projectId);
    },
  });
}
