import { EntityIdSchema, parseCanonical, strictObject, z, type Run } from '@lucid-fin/contracts';
...
export function createRunSchedulingReadModel(store: Store): RunSchedulingReadModel {
