...
export const CharactersTable = defineTable('characters', {
  ...
  face: col<string | null>('face'),
  hair: col<string | null>('hair'),
  skinTone: col<string | null>('skin_tone'),
  body: col<string | null>('body'),
  distinctTraits: col<string | null>('distinct_traits'),
  vocalTraits: col<string | null>('vocal_traits'),
...
export const EquipmentTable = defineTable('equipment', {
  ...
  material: col<string | null>('material'),
  color: col<string | null>('color'),
  condition: col<string | null>('condition'),
  visualDetails: col<string | null>('visual_details'),
  tags: col<string | null>('tags'),
  referenceImages: col<string | null>('reference_images'),
  folderId: col<string | null>('folder_id'),
