...
export const ToolCatalog = createCatalog([
  ...
  characterUpdate,
  characterDelete,
  characterGenerateRefImage,
  characterSetRefImage,
  characterDeleteRefImage,
  characterSetRefImageFromNode,
  // location
  locationList,
  locationCreate,
  locationUpdate,
  locationDelete,
  locationGenerateRefImage,
  locationSetRefImage,
  locationDeleteRefImage,
  locationSetRefImageFromNode,
  // equipment
  equipmentList,
  equipmentCreate,
  equipmentUpdate,
  equipmentDelete,
  equipmentGenerateRefImage,
  equipmentSetRefImage,
  equipmentDeleteRefImage,
  equipmentSetRefImageFromNode,
  // canvas structure
  canvasAddNode,
  canvasBatchCreate,
  ...
  canvasLayout,
  canvasDeleteEdge,
  canvasSwapEdgeDirection,
  canvasDisconnectNode,
  ...
  canvasPreviewPrompt,
  // preset tracks
  canvasReadNodePresetTracks,
  canvasWriteNodePresetTracks,
  canvasWritePresetTracksBatch,
  canvasAddPresetEntry,
  canvasRemovePresetEntry,
  canvasUpdatePresetEntry,
  // shot templates
  canvasApplyShotTemplate,
  shotTemplateList,
  shotTemplateCreate,
  shotTemplateUpdate,
  shotTemplateDelete,
  ...
  canvasSetNodeProvider,
  canvasSetImageParams,
  canvasSetVideoParams,
  canvasSetAudioParams,
  // series
  seriesGet,
  seriesUpdate,
  seriesListEpisodes,
