...
function securityConfigurationFailed(): TargetStorageError {
...
function corruptRecoveryData(): TargetStorageError {
  return new TargetStorageError('CORRUPT_DATA', 'Private recovery data cannot be authenticated');
}
