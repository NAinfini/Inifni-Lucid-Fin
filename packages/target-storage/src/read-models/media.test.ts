...
function insertProject(database: ReturnType<typeof getTargetStoreDatabase>, id: string): void {
  database
    .prepare(
...
function seedMedia(database: ReturnType<typeof getTargetStoreDatabase>, value: MediaSeed) {
  insertOrValidateMediaBlob(
    database,
    {
      hash: value.blobHash,
