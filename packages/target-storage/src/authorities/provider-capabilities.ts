import { ProviderCapabilitiesDefinition, canonicalJson } from '@lucid-fin/target-contracts';
...
function loadProfiles(store: TargetStore): readonly ProviderCapabilitiesProfile[] {
  const rows = getTargetStoreDatabase(store)
    .prepare(
