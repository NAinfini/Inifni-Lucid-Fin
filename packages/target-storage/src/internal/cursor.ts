import { canonicalJson, parseCanonical, strictObject, z } from '@lucid-fin/target-contracts';
...
export function decodeCursor(cursor: string | null, scope: string): string | null {
  ...
  try {
    ...
    throw new TargetStorageError('INVALID_REQUEST', 'Cursor is invalid for this query', { cause });
  }
}
