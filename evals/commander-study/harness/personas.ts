...
const TEMPLATES: Array<Omit<Persona, 'index'>> = [
  ...
  {
    archetype: 'story',
    slug: 'cyberpunk-neon-short',
    opener:
      'Make me a 45-second cyberpunk short: lone courier runs across neon rooftops, ends on a rooftop confrontation. 9:16 vertical. High-contrast neon.',
    followUps: [
      'Use Flux for images. Keep 2 characters: courier + pursuer.',
      'Yes use a style-plate.',
      'OK render.',
      'You decide.',
    ],
  },
  {
    archetype: 'story',
    slug: 'cozy-cafe-romance',
    opener:
      "A two-shot romance opener: couple meets in a rainy Seoul cafe. Want a 'before sunrise' vibe, warm lighting, 16:9 cinematic.",
    followUps: [
      'Two characters, no names yet.',
      'Use a warm pastel style-plate.',
      'Skip audio for now.',
      'You choose.',
    ],
  },
  ...
  {
    archetype: 'story',
    slug: 'fantasy-village-intro',
    opener:
      'Fantasy village intro scene. 8 shots. Establishing crane shot -> market walkabout -> villain arrival -> villagers scatter -> hero draws weapon. 16:9.',
    followUps: [
      'Characters: hero (young, scarred), villain (cloaked).',
      'Villages medieval European.',
      'Use a dark/ominous style plate.',
      'You choose.',
    ],
  },
  {
    archetype: 'story',
    slug: 'sci-fi-dream-sequence',
    opener:
      'Surreal sci-fi dream sequence. Girl walks through corridors that bend gravity. 30 seconds. MC Escher vibe. 16:9.',
    followUps: [
      'One character: girl in white.',
      'Yes style-plate: muted grayscale.',
  ...
  {
    archetype: 'story',
    slug: 'western-duel-climax',
    opener:
      'Duel scene climax. Two gunslingers. Dusty western town. 20 seconds. Heavy close-ups on eyes, boots, hands, holster. Then wide + gunshot. 2.39:1.',
    followUps: [
      'Characters: grizzled veteran vs young upstart.',
      'Style-plate: sergio leone.',
      'Leave audio out.',
      'Your call.',
    ],
  },
  {
    ...
    slug: 'zh-horror-tale',
    opener:
      '做一个45秒的中式恐怖短片，废弃筒子楼，主角听见楼道脚步声，最后揭示镜子里没有倒影。9:16。',
  ...
  },
  {
    ...
    opener:
      'Docu-style: Ming dynasty ship sets sail from Nanjing, 1405. Treasure fleet. 8 shots, documentary narration planned. 16:9.',
    followUps: [
      'One character: Zheng He.',
      'Period-accurate style plate.',
      'Yes add voice-over slot.',
      'You pick.',
    ],
  },
  {
    archetype: 'story',
    slug: 'noir-detective-open',
    opener:
      'Black-and-white noir opener: detective in office, rain streaks down blinds. Venetian blind shadows. 2.39:1. Monologue planned.',
    followUps: [
      'One character: detective.',
      'Pure B&W style plate.',
      'Include voice-over slot.',
      'You decide.',
    ],
  },
  ...
  // === vague / exploratory (10) ===
  {
    ...
    followUps: [
      'Surprise me. Anything cinematic.',
      'OK pick one and run with it.',
      'Keep it under 60s.',
      'You decide.',
    ],
  },
  {
    ...
    followUps: [
      'OK, a short story. Whatever you think is easy.',
  ...
  },
  {
    ...
    followUps: [
      'Story: lonely astronaut on abandoned Mars base.',
      'Pick any style.',
      'Lock it in.',
      'You decide.',
    ],
  ...
  {
    archetype: 'power',
    slug: 'shot-list-first',
    opener:
      'I have a 12-line shot list. Paste it in, create nodes for each shot, set a consistent style-plate, then let me review before generating.',
    followUps: [
      'Shot list: wide exterior dawn / tight hero face / OTS on villain / chase / crash / aftermath / eulogy / title card / flashback / memorial / walk-away / FIN.',
  ...
  {
    archetype: 'power',
    slug: 'script-to-canvas',
    opener:
      'I have a fountain-format script (3 scenes). I want to import it and auto-generate nodes by shot template.',
    followUps: [
      'Scene 1: INT. CAFE - DAY. Two characters meet. Scene 2: EXT. STREET. They argue. Scene 3: INT. APARTMENT - NIGHT. Reconciliation.',
  ...
  },
  {
    ...
    slug: 'batch-reprompt',
    opener:
      'I already have 8 image nodes but their prompts are inconsistent. Please batch re-prompt with a single style reference.',
    followUps: [
      'Reference node: node-0 (the first one in the chain).',
      'Apply to nodes 1-7.',
  ...
  {
    archetype: 'power',
    slug: 'character-lock-then-shots',
    opener:
      'Create 3 characters, generate ref images for each, THEN create 10 shot nodes referencing them.',
    followUps: [
      'Characters: Lina (courier, 28), Mara (her sister, 24), Kade (antagonist, 35).',
  ...
  {
    archetype: 'power',
    slug: 'location-consistency',
    opener:
      "I'm worried about location consistency across 12 shots. Lock 2 locations with ref images, then create shots referencing them.",
    followUps: [
      'Locations: Neo-Tokyo alley, rooftop garden.',
  ...
  },
  {
    ...
    followUps: ['用第一个节点当参考。', '全部已有节点应用。', '先预览差异。', '确认。'],
  },
  {
    archetype: 'power',
  ...
  },
  {
    ...
    slug: 'preset-remix',
    opener:
      "List all shot templates + presets you have, then design a remix of 3 presets into a new one for my 'rainy noir rooftop' look.",
    followUps: [
      'Combine ominous + low-key-lighting + rain-atmos.',
  ...
  {
    archetype: 'power',
    slug: 'voice-lip-pipeline',
    opener:
      'I want a voice + lip-sync pipeline: generate 3 audio takes, then drive lip-sync on a character video node.',
    followUps: [
  ...
  // === edge / abuse (10) ===
  {
    ...
    opener: '.',
    followUps: [
      'No project yet, just wanted to see what happens.',
      'OK make something anyway.',
      'You decide.',
      'You decide.',
    ],
  },
  ...
  },
  {
    ...
    slug: 'conflict-asks',
    opener:
      'Make a 2-minute horror and a 30-second comedy, same canvas, tell me which to render first.',
    followUps: [
      'Let the agent decide.',
      'Use separate style plates.',
      'Render horror first.',
      'You decide.',
    ],
  },
  ...
  {
    archetype: 'edge',
    slug: 'skip-style-plate',
    opener:
      "Build me a 5-shot sequence but don't bother with a style-plate, I don't care about consistency.",
  ...
  },
  {
    ...
    followUps: [
      'Yes wipe.',
      'Lighthouse at dawn, at dusk, at storm.',
      'Style-plate: weathered realism.',
      'Generate.',
    ],
  },
  {
    archetype: 'edge',
    slug: 'rapid-fire-changes',
    opener:
      'Make a fantasy scene. Actually, make it sci-fi. Actually make it a cooking video. Pick whichever, you decide.',
  ...
  {
    archetype: 'edge',
    slug: 'ask-for-undocumented',
    opener: "Export my canvas as a CapCut project. Also import an SRT file I don't have yet.",
    followUps: [
      'Export whatever canvas exists.',
      "Skip the SRT since I don't have one.",
      'Proceed.',
      'You decide.',
    ],
  },
  ...
  {
    archetype: 'docs',
    slug: 'what-is-style-plate',
    opener: "What's a style plate and why do I need one? Show me by locking one on a fresh canvas.",
    followUps: [
      'Lock one for a misty-forest-at-dawn look.',
      'Apply to 2 new image nodes.',
      'Generate.',
      'You decide.',
    ],
  },
  {
    ...
    followUps: [
      'Now use the canvas ones to build a tiny project.',
      'Style-plate: minimal.',
      'Generate 1 node.',
      'You decide.',
    ],
  ...
  {
    archetype: 'docs',
    slug: 'preset-inventory',
    opener: 'List every preset + shot template and demo one of each.',
    followUps: [
      'Pick a cinematic preset and a wide-shot template.',
      'Apply to a new node.',
      'Generate.',
      'You decide.',
    ],
  ...
  // === ads / marketing (5) ===
  {
    ...
    opener:
      '15-second product hero shot: luxury watch on rotating display, soft gradient backdrop, macro detail pass, end on logo.',
  ...
  },
  {
    ...
    slug: 'food-ad',
    opener:
      'Noodle bowl ad. Steam rises, chopsticks pull noodles out. Warm studio lighting. 9:16 for social.',
    followUps: [
      'Style: food-studio.',
      '4 shots: wide, close, pull, logo.',
      'Generate.',
      'You pick.',
    ],
  },
  {
    archetype: 'ad',
    slug: 'car-commercial-teaser',
    opener:
      'EV teaser ad, 20 seconds. Car on empty salt flats at dawn, silent, then sudden acceleration. 16:9 cinematic.',
...
if (import.meta.url === `file://${process.argv[1]}` || process.argv[1]?.endsWith('personas.ts')) {
  ...
  for (const p of personas) {
    console.log(
      `  [${String(p.index).padStart(2)}] ${p.archetype.padEnd(14)} ${p.slug.padEnd(26)} ${p.opener.slice(0, 60).replace(/\n/g, ' ')}${p.opener.length > 60 ? '...' : ''}`,
    );
  }
}
