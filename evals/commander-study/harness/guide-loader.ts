...
const BUILT_IN_SEEDS: SeedSpec[] = [
  // promptTemplate cohort
  {
    ...
    relPath: `${GUIDE_DIR}/00-meta-prompt.md`,
  },
  {
    id: 'prompt-structure',
    name: 'Prompt Structure & Fundamentals',
    relPath: `${GUIDE_DIR}/01-prompt-structure.md`,
  },
  {
    id: 'camera-composition',
    name: 'Camera & Composition',
    relPath: `${GUIDE_DIR}/02-camera-and-composition.md`,
  },
  {
    id: 'lighting-atmosphere',
    name: 'Lighting & Atmosphere',
    relPath: `${GUIDE_DIR}/03-lighting-and-atmosphere.md`,
  },
  {
    id: 'motion-emotion',
    name: 'Motion & Emotion',
    relPath: `${GUIDE_DIR}/04-motion-and-emotion.md`,
  },
  {
    id: 'style-aesthetics',
    name: 'Style & Aesthetics',
    relPath: `${GUIDE_DIR}/05-style-and-aesthetics.md`,
  },
  {
    id: 'workflow-methods',
    name: 'Workflow Methods',
    relPath: `${GUIDE_DIR}/06-workflow-methods.md`,
  },
  {
    id: 'model-adaptation',
    name: 'Model-Specific Adaptation',
    relPath: `${GUIDE_DIR}/07-model-specific-adaptation.md`,
  },
  ...
  // workflowDefinitions cohort
  {
    ...
    relPath: `${SKILLS_DIR}/wf-novel-to-video.md`,
  },
  {
    id: 'wf-video-clone',
    name: 'Video Clone → Remake',
    relPath: `${SKILLS_DIR}/wf-video-clone.md`,
  },
  {
    id: 'wf-style-transfer',
    name: 'Style Transfer Across Shots',
    relPath: `${SKILLS_DIR}/wf-style-transfer.md`,
  },
  {
    id: 'sk-reverse-prompt',
    name: 'Reverse Prompt Inference',
    relPath: `${SKILLS_DIR}/sk-reverse-prompt.md`,
  },
  ...
  { id: 'sk-capcut-export', name: 'CapCut Export', relPath: `${SKILLS_DIR}/sk-capcut-export.md` },
  {
    ...
    relPath: `${SKILLS_DIR}/sk-semantic-search.md`,
  },
  {
    id: 'sk-multi-view',
    name: 'Multi-View Canvas Editing',
    relPath: `${SKILLS_DIR}/sk-multi-view.md`,
  },
...
if (
  ...
  process.argv[1]?.endsWith('guide-loader.ts')
) {
