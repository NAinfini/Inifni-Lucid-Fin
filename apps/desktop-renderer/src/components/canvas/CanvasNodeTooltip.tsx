...
export function CanvasNodeTooltip({ children, title, subtitle, items }: CanvasNodeTooltipProps) {
  ...
  return (
    <TooltipProvider delayDuration={180}>
      <Tooltip>
        ...
        <TooltipContent
          side="top"
          className="max-w-64 rounded-xl border border-border bg-card/95 p-3 text-card-foreground shadow-2xl"
        >
