...
function VideoNodeComponent({ data, selected }: NodeProps) {
  ...
  const { url: videoUrl } = useAssetUrl(lod === 'minimal' ? undefined : activeHash, 'video', 'mp4');
    ...
    >
      <div ref={visibilityRef} className="relative h-full min-h-[140px] min-w-[200px] w-full">
        ...
        >
          ...
          {/* LOD: minimal = colored placeholder only */}
          {lod === 'minimal' ? (
            <div className="flex flex-1 items-center justify-center bg-purple-500/5">
            ...
            <>
              ...
              >
                {hasVideo ? (
                  <div
                    ...
                    onClick={handleClick}
                  >
                    {/* Video element: only mounted when node is in viewport */}
                    {videoUrl && isVisible ? (
                      <video
                      ...
                      <div className="flex h-full w-full items-center justify-center bg-muted">
                        <Video className="h-8 w-8 text-purple-400/40" />
                      </div>
                    ) : (
              ...
              {/* LOD: medium skips progress bar, error, frame previews, variants, generate bar, preset summary */}
              {lod === 'full' && (
                <>
