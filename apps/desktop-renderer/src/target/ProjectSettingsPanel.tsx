...
import type { Project, ProjectSettings, TargetDesktopCallV1 } from '@lucid-fin/target-contracts';
...
interface ProjectSettingsPanelProps {
  ...
  readonly capabilities: TargetResult<'project.capabilities.get'> | null;
  readonly capabilitiesError: string | null;
  readonly pluginPackages: TargetResult<'plugin.query'> | null;
  ...
  readonly onPluginApply: (input: TargetDesktopCallV1<'plugin.apply'>['input']) => Promise<void>;
...
export function ProjectSettingsPanel({
  ...
  const applyPlugin = async (
    entry: TargetResult<'plugin.query'>['packages'][number],
  ...
  return (
    <div className="target-settings-backdrop">
      <section
        ref={dialogRef}
        className="target-project-settings-panel"
        role="dialog"
        aria-modal="true"
        aria-labelledby="target-project-settings-title"
        onKeyDown={(event) => {
          if (event.key === 'Escape') {
      ...
      >
        <header>
          <div>
            ...
            <h2 id="target-project-settings-title">
        ...
        <div className="target-project-settings-body">
          <div className="target-settings-basics">
            <label>
            ...
            <div className="target-settings-format-fact">
          ...
          <section className="target-settings-section target-settings-budget">
            <header>
            ...
            <div className="target-settings-budget-grid">
              <label>
          ...
          {capabilitiesError !== null ? (
            <div className="target-settings-catalog-error" role="alert">
            ...
            <div className="target-settings-catalog-loading" role="status">
            ...
            <>
              <section className="target-settings-section">
                ...
                <label>
                  <span>{targetCopy(locale, 'model')}</span>
                  <select
              ...
              <section className="target-settings-section target-settings-skills">
                <header>
                  <strong>
                ...
                <div className="target-settings-skill-list">
              ...
              <section className="target-settings-section target-settings-plugin-boundary">
                <header>
                ...
                {pluginPackagesError !== null ? (
                  ...
                  <p className="target-settings-plugin-empty">
                    {locale === 'zh-CN'
                      ? '此 Build 没有注册受信任插件包。'
                      : 'This build has no registered trusted Plugin packages.'}
                  </p>
                ) : (
                  <div className="target-settings-plugin-list">
